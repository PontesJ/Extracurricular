...
```
 GC,  marca Hond e ano 2013 
 Barulho emitido pela GC
 biiip biiiip biiip 

 Gool,  marca VW e ano 2019 
 Barulho emitido pelo Gool
 baaaaanp baaaaaanp baaaanp 

 Trucker,  marca GM e ano 2018 
 Barulho emitido pelo Trucker
 fooon foooooon fooon 
```
...
Crie as classes Animal, Cao, Gato; faça as devidas associações; crie duas propriedades, sendo elas nome e raça; e use os conceitos de Overloading e Overriding para criar os métodos emitirSom( ), comer( ), escalar( ) e babar ( ). Exclusivamente para o método comer( ), receba a comida via parâmetro.
...
```
Rex, da raça Fila, adoro bife
Au au
Babei! 

Mimi, da raça Persa, adoro atum
Miauuu
Subindo...
```